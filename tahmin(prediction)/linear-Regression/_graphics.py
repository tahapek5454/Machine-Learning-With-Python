...
# oncelikle grafikte duzgun sirada gelmesi icn verileri siraya sokalim indexe gore
...
plt.plot(x_test_sorted,y_test_sorted)
plt.plot(x_test,my_prediction) # bu sekilde train ve tahminlerin grafigini gormus olacagiz
